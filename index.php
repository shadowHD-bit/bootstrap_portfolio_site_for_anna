...
<section id="section5" class="vh-100 gradient-custom" style="background-repeat: no-repeat;
    ...
    background-size: cover; background-image: url('./img/section2.jpg'); padding-top: 150px;">
      <p class="pb-3 text-center" style="font-family: 'Lobster', cursive; font-size: 45px; color:#fff">Мои фотографии</p>
...
<div class="text-center pt-5"><a href="./mygallary.php"><button class="btn btn-dark btn-sx" type="button">Посмотреть другие работы</button></a></div>
